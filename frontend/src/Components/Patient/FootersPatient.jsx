						...
						<div className="col-lg-3 col-md-6">
							<div className="footer-widget footer-menu">
								...
								<ul>
									...
									{/* <li><Link to={'/appointment'}><FaAngleDoubleRight className='icon' />  Book Appointments</Link></li> */}
									<li><Link to={'/user'}><FaAngleDoubleRight className='icon' />  My Profile</Link></li>
									<li><Link to={'/patient/appointment'}><FaAngleDoubleRight className='icon' />  My Appointments</Link></li>
									<li><Link to={'/report'}><FaAngleDoubleRight className='icon' />  Reports</Link></li>
									<li><Link to={'/transactions'}><FaAngleDoubleRight className='icon' />  Transactions</Link></li>
									<li><Link to={'/review'}><FaAngleDoubleRight className='icon' />  Give Feedback</Link></li>
