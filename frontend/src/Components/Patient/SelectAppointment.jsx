...
const SelectApppointment = ({ selectedDate, handleDateChange, selectTime, setSelectTime, doctorId ,  }) => {
    ...
    const upcoming5Days = Array.from({ length: 5 }, (_, index) =>
                    ...
                    <div className="col-md-3 col-sm-12 mt-3 info-part border-end">
                        ...
                        <div className='icon-box'>
                            ...
                            {/* <div className='d-flex gap-3'>
                                ...
                                <p>My City, India<br /><span className="form-text">102, My City, NorthEast,My City</span></p>
                            </div> */}
                            {/* <div className='d-flex gap-3'>
